...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static HashSet<GameObject> FindGameObjectsWithComponent(Type type)
        {
            ...
            Component[] targetComponents = (Component[]) GameObject.FindObjectsByType(type, 0);

            /*
             * Object[] objects = Object.FindObjectsOfType(someType, true);
             * or
             * Object[] objects = Object.FindObjectsOfType(someType, false);
             */
        ...
        {
            PhotonHandler[] photonHandlers = GameObject.FindObjectsByType(typeof(PhotonHandler), 0) as PhotonHandler[];
